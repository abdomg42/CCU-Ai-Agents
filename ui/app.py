"""Interface utilisateur Streamlit pour le Diagnostic Technique CCU.

Cette application remplace le chatbot Next.js. Elle appelle directement
l'API FastAPI (par défaut http://localhost:8000) et streame la progression
du pipeline LangGraph via l'endpoint SSE /diagnose/stream.
"""
